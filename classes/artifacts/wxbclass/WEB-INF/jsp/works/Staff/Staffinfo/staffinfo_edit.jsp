		...
		<table id="table_report" class="table table-striped table-bordered table-hover">
			...
			<c:if test="${msg=='edit'}">
				<tr>
					...
					<td><input   type="text" name="shop_staff_name" id="shop_staff_name" value="${pd.shop_staff_name}"  maxlength="32" placeholder="这里输入员工名称" title="员工名称"/></td>
				</tr>


				<tr>
					<td style="width:70px;text-align: right;padding-top: 13px;">手机号:</td>
					<td><input  type="text" name="shop_staff_tel" id="shop_staff_tel" value="${pd.user_tel}" maxlength="32" placeholder="这里输入手机号" title="仓库地址"/></td>
				</tr>
			</c:if>
			...
			<c:if test="${msg=='save'}">
				...
				<tr>
					...
					<c:if test="${pd.role_id=='1'}">
						<td><input type="text" readonly="true" name="role_name" id="role_name" value="${pd.role_name}" maxlength="32" placeholder="这里输入仓库类型" title="仓库类型"/></td>
					</c:if>
			...
			<tr>
				...
				<c:if test="${msg=='edit'}">
					<td><input type="text" readonly="true" name="shop_name" id="shop_name" value="${pd.shop_name}" maxlength="32" placeholder="这里输入仓库类型" title="仓库类型"/></td>
				</c:if>
