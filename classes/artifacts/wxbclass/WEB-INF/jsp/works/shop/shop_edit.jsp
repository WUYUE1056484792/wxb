...
<body>
	<form action="${msg}.do" name="userForm" id="userForm" method="post">
		...
		<table>
			...
			<tr>
				...
				<td>
					<c:if test="${shop.license_photo!=null}">
						<img src="${shop.license_photo}" style="width: 400px"   alt="">
					</c:if>
			...
			<tr>
				<td>责任人身份证照片正面：</td>
				<td><c:if test="${shop.director_photo_a!=null}">
					<img src="${shop.director_photo_a}" style="width: 400px"  alt="">
				</c:if>
					</td>
			</tr>
			<tr>
				...
				<td><c:if test="${shop.director_photo_b!=null}">
					<img src="${shop.director_photo_b}" style="width: 400px" alt="">
				</c:if>
